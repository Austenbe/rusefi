...
DDEFS += -DSTM32_SERIAL_USE_UART7=TRUE -DSTM32_SERIAL_UART7_PRIORITY=6
DDEFS += -DTS_PRIMARY_UxART_PORT=SD7 -DEFI_TS_PRIMARY_IS_SERIAL=TRUE

DDEFS += -DIBUS_SERIAL_DEVICE=SD7

DDEFS += -DEFI_CONSOLE_RX_BRAIN_PIN=Gpio::F6
DDEFS += -DEFI_CONSOLE_TX_BRAIN_PIN=Gpio::F7
